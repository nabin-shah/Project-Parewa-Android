...
public class PniAccountInitializationMigrationJob extends MigrationJob {
  ...
  public void performMigration() throws IOException {
    ...
    if (!metadataStore.isSignedPreKeyRegistered()) {
      ...
      NetworkResultUtil.toPreKeysLegacy(SignalNetwork.keys().setPreKeysSync(new PreKeyUpload(ServiceIdType.PNI, signedPreKey, oneTimePreKeys, null, null, protocolStore.getIdentityKeyPair().getPublicKey(), protocolStore.getLocalRegistrationId())));
