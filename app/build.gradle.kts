...
android {
  ...
  defaultConfig {
    ...
    buildConfigField("String", "SIGNAL_URL", "\"https://192.168.178.200\"")
    buildConfigField("String", "STORAGE_URL", "\"https://192.168.178.200\"")
    buildConfigField("String", "SIGNAL_CDN_URL", "\"https://192.168.178.200\"")
    buildConfigField("String", "SIGNAL_CDN2_URL", "\"https://192.168.178.200\"")
    buildConfigField("String", "SIGNAL_CDN3_URL", "\"https://192.168.178.200\"")
    buildConfigField("String", "SIGNAL_CDSI_URL", "\"https://192.168.178.200\"")
    buildConfigField("String", "SIGNAL_SERVICE_STATUS_URL", "\"192.168.178.200\"")
    buildConfigField("String", "SIGNAL_SVR2_URL", "\"https://192.168.178.200\"")
    buildConfigField("String", "SIGNAL_SFU_URL", "\"https://192.168.178.200\"")
    buildConfigField("String", "SIGNAL_STAGING_SFU_URL", "\"https://192.168.178.200\"")
    ...
    buildConfigField("String", "CONTENT_PROXY_HOST", "\"192.168.178.200\"")
